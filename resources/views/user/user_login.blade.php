					 ...
					 <form class="form-horizontal" action="{{url('user/checkLogin')}}" method="post">
						...
						<div class="input-prepend" title="Email Address" data-rel="tooltip">
								<span class="add-on"><i class="icon-user"></i></span>
								    <input autofocus class="input-large span10" name="email" id="username" type="text" placeholder="Enter your email address" />
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Password" data-rel="tooltip">
								<span class="add-on"><i class="icon-lock"></i></span>
								    <input class="input-large span10" name="password" id="password" type="password" placeholder="Enter your passward"/>
							</div>
							<div class="clearfix"></div>
							...
							<button type="button" class="btn btn-warning" id="forget_pass">Forget Password</button>
                                ...
                                <a href="{{url('/user_registration')}}" class="btn btn-primary">New? Register Here</a>
							</p>
						</div>
